...
from slopcontrol.domains.cad.tools.session_manager import SessionManager, DesignState
from slopcontrol.domains.cad.tools.cad import CAD_TOOLS, create_box, export_model
from slopcontrol.domains.cad.tools.visualization import render_preview
from slopcontrol.domains.cad.tools.design_history import DesignHistory
    ...
    if not TEXTUAL_AVAILABLE:
        console.print(
            Panel.fit(
                ...
                "Or use CLI mode: slopcontrol design [prompt]",
