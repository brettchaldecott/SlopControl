...
class TestCadTools:
    ...
    def test_create_circle_tool(self):
        ...
        from cadai.tools.cad import create_circle
    ...
    def test_export_tool(self):
        ...
        from cadai.tools.cad import export_model
