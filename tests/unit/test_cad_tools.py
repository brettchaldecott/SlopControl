...
class TestCadTools:
    ...
    def test_create_box_tool(self):
        ...
        from planforge.domains.cad.tools.cad import create_box
    ...
    def test_create_cylinder_tool(self):
        ...
        from planforge.domains.cad.tools.cad import create_cylinder
    ...
    def test_create_sphere_tool(self):
        ...
        from planforge.domains.cad.tools.cad import create_sphere
    ...
    def test_create_circle_tool(self):
        ...
        from planforge.domains.cad.tools.cad import create_circle
    ...
    def test_extrude_tool(self):
        ...
        from planforge.domains.cad.tools.cad import extrude_sketch

        assert extrude_sketch is not None

    def test_fillet_tool(self):
        """Test fillet tool exists."""
        from planforge.domains.cad.tools.cad import add_fillet

        assert add_fillet is not None

    def test_boolean_tools(self):
        """Test boolean operation tools exist."""
        from planforge.domains.cad.tools.cad import union_bodies, cut_body, intersect_bodies
